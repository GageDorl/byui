...
SELECT last_name, first_name,
 ...
 floor(DATEDIFF('2017-1-5', birthdate)%365) AS Days,
 CONCAT(floor(DATEDIFF('2017-1-5', birthdate)/365),' - Yrs, ', floor(DATEDIFF('2017-1-5', birthdate)%365), ' - Days') AS 'Years and Days'
 FROM students
 ORDER BY birthdate;
